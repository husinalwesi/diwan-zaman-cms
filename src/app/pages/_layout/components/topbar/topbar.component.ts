...
export class TopbarComponent implements OnInit, AfterViewInit {
  langs: any = [
    { flag: "./assets/media/svg/flags/226-united-states.svg", title: "English", code: "en" },
    { flag: "./assets/media/svg/flags/077-jordan.svg", title: "عربي", code: "ar" }    
  ];
  selectedLang: number = 0;//first lang
  currentUser: any;
  // tobbar extras
  ...
  constructor(private layout: LayoutService, private auth: AuthService, private translationService: TranslationService) {}
  ...
  ngOnInit(): void {
    ...
    this.selectedLang = this.translationService.getSelectedLanguage() == "en" ? 0 : 1;
  }
  ...
  setLang(langIndex){
    this.selectedLang = langIndex;
    this.translationService.setLanguage(this.langs[langIndex].code);
